    ...
    _createClass(Eliura, [
      ...
      },
      {
        ...
        value: function transfAddLevel(xPath, element) {
          ...
          console.log("transfAddLevel", output);
          return output;
        },
      },
      {
    ...
    _createClass(XPath, [
      ...
      },
      {
        ...
        value: function headHasPositionPredicate() {
          ...
          return (
            splitXPath[2].includes("position()") || // [position()]
            splitXPath[2].includes("last()") || // [last()]
            regExp.test(splitXPath[2]) // P[3]
          );
        },
      },
      {
